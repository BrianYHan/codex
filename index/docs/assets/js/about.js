...
//USC
  ...
  var uscCheck_flag = false;

  var uscCheck = function() {
    if (uscCheck_flag == false) {
        uscDisplay();
    }
    else {
        uscHide();
  ...
  var uscDisplay = function() {
    $("#usc").slideDown(1000);
    $("#uscTA").slideDown(1000);

    
    $("#uscSelect").attr("class", "ui-selecting")    
    uscCheck_flag = true;      
  };

  var uscHide = function() {
    $("#usc").slideUp(1000);    
    $("#uscTA").slideUp(1000);

    $("#uscSelect").attr("class", "ui-selected")   
    uscCheck_flag = false;
  };
...
/* Try and pull it slower. use help link to scroll to where the accordion is
*/
...
//CV keys
    ...
    var keyTerm = new Array
      ...
      cvBlock[6] = "skills" ; keyTerm [6] = "coding microsoft excell office adobe skills";
